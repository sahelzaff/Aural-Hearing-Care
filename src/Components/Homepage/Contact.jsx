    ...
    <div className='w-full h-full bg-auralyellow py-16'>
      <div className='px-16'>
        ...
        <div className='flex flex-row items-center justify-center pt-10 '>
          <div className='flex items-start justify-start gap-5 w-1/3'>
            <FaLocationArrow className='text-auralblue text-8xl ' />
          ...
          <div className='flex items-center justify-center gap-5 w-1/3'>
            <FaPhoneAlt className='text-auralblue text-4xl' />
            <h1 className='font-poppins text-lg text-white'>+91 98234 49422</h1>
          </div>
          <div className='flex items-center justify-center gap-5 w-1/3'>
            <MdOutlineAccessTime className='text-auralblue text-6xl' />
            <h1 className='font-poppins text-lg text-white'>Mon - Fri <br />10am - 7pm</h1>
